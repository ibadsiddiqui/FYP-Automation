    ...
    render() {
        return (
            <nav className="navbar navbar-expand navbar-dark bg-dark static-top">
                ...
                <a className="navbar-brand mr-1" href="index.html">Welcome</a>
                ...
                <ul className="navbar-nav ml-auto ml-md-0">
                    <li className="nav-item dropdown no-arrow mx-1">
                        ...
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="NotificationsDropdown">
                            <a className="dropdown-item" href="#">New Notification</a>
                            <div className="dropdown-divider"></div>
                            <a className="dropdown-item" href="#">All Notifications</a>
                        </div>
                    </li>
                    ...
                    {/* Message Drop Down-->
                        <!-- is there communication between supervisors and students?? -->
                        <!-- need a sharing div also */}
                    ...
                    <li className="nav-item dropdown no-arrow mx-1">
                        ...
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="Messages">
                            <a className="dropdown-item" href="#">New Message</a>

                            <div className="dropdown-divider"></div>
                            <a className="dropdown-item" href="#">Old Messages</a>
                        </div>
                    </li>
